<%-- 
    Document   : editarProductos3.jsp
    Created on : May 4, 2021, 9:53:35 AM
    Author     : Emiliano
--%>
    ...
    <%
                ...
                try{
                    ...
                    try{
                        ...
                        String j = "select * from products";
                        set = con.createStatement();
                        
                        rs = set.executeQuery(j);
                        while(rs.next()){
                            if(rs.getString("producto").equals(producto)&&rs.getInt("id")!=idF){
                                rep = false;
                            }
                        }
                        if(rep){
                            String k = "update products set producto = '"+producto+"', "
                                    + "precio = "+precio+", descuento = "+descuento+", descripcion = '"+descripcion+"' "
                                    + "where id = "+idF+"";
                            int actualizar = set.executeUpdate(k);
                        }
